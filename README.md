...
<img src="src/로그인2.png" width="250" height="400"/>
로그인이 가능 합니다.
사용자가 원하는 이메일과 비밀번호로 회원가입을 할 수 있으며, 회원가입 후 서버에 계정이 업로드 되고, 그 정보를 바탕으로 로그인을 할 수 있습니다.

<img src="src/메인화면.png" width="250" height="400"/>
...
<img src="src/피드백화면1.png" width="250" height="400"/>
